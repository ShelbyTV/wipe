...
//, db = require('./init_db')(conf.db) 
, ENV = process.env.NODE_ENV
, redis = require('redis')
, redis_client = redis.createClient(6379, conf.db[ENV].redis_host)
, doQuery = require('./do_query.js')
, doDelete = require('./do_delete.js')
, equipFields = require('./equip_fields.js');

// Connect to DB 
var wipe_user = function(db_client, USER_NICKNAME, _callback){
...
module.exports = function(db_client, username, cb){
  console.log('commencing wipe of', username);
  wipe_user(db_client, username, cb); 
};
