...
module.exports = function(db_conf){
  ...
  switch (env){
    ...
    case 'production':
      var replServers = [];
      replServers[0] = new Server(db_conf.production.hosts[0], db_conf.production.ports[0], {auto_reconnect:true})
      replServers[1] = new Server(db_conf.production.hosts[1], db_conf.production.ports[1], {auto_reconnect:true})
